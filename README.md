...
- ユーザー編集機能(管理者権限／メールアドレス変更／パスワード変更)
- 商品機能(新規作成／編集／削除)
- 単価機能(新規作成／編集／削除)
- 見積機能(新規作成)
- 商品機能(新規作成／編集／削除)
...
| 単価を登録できます。 | 単価を編集・削除できます。単価詳細画面から発注ができます。 |

| 単価登録画面 |
| ---- |
| ![単価登録画面](/public/img/greenshot01.png) |
| 単価を登録できます。 |
...
- 検索部分です。<br>画面の占領範囲を小さくするためにタブにしました。<br>各タブで検索後も別のタブ検索内容が保存されるようにして、再検索しやすいようにしました。

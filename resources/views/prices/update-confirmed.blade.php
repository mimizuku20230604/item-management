        ...
        <div class="card-header">
          <form method="post" action="{{ route('price.update', $price) }}" >
              ...
              <div class="form-group">
                  ...
                  <input type="date" name="deadline_date" class="form-control" id="deadline_date" value="{{ $price['deadline_date'] }}" readonly>
              </div>
              <div class="form-group">
              ...
              <button type="submit" class="btn btn-outline-success mt-3">更新</button>
          </form>

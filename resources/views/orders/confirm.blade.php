    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
              ...
              <div class="form-row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    {{-- <input type="text" name="registration_price" class="form-control" id="registration_price" value="{{ number_format($formData['registration_price'], 2) }}" readonly> --}}
          ...
          <button type="button" class="btn btn-outline-secondary mt-3" onclick="window.history.back();">入力画面に戻る</button>
          <br>
